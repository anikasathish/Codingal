...
print("Gesture control scroll active\nShow your hand to the camera and make a fist to scroll down or open hand to scroll up.")
while cap.isOpened():
    ...
    p_time = time.time()
    cv2.putText(img, f"FPS: {int(fps)} | Hand: {handedness} | Gesture: {gesture}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
